...
const GREEN_COLOR = "#4A7A4A";
const BLUE_COLOR = "#2A5A8A";
...
export default function NoticeVisionExpansionRings() {
  const [ref, inView] = useInView(0.1);
  const [hoveredRing, setHoveredRing] = useState<number | null>(null);

  return (
    <div ref={ref} className="nver-root">
      <style>{`
        .nver-root {
          margin: 48px auto;
          max-width: 720px;
      ...
      <div className="nver-ring-area">
        ...
        {rings.map((ring, i) => {
          ...
          return (
            ...
            >
              <div className="nver-ring-label" style={{
      ...
      {/* Detail cards below */}
      <div className="nver-detail-row" style={{
        opacity: inView ? 1 : 0,
