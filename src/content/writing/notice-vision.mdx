...
This distinction, drawn from [[ref:barrett-2017|Barrett's]] [[term:constructed-emotion|constructed emotion theory]] and [[term:jhourney|Jhourney's]] contemplative pedagogy, is the deepest design constraint in the product. Emotion labels are frames, not facts. The app's job is to support noticing without grasping.
