...
For me personally, the thing that cracked this open was a jhana retreat. I learned to feel things I'd been walking around with my whole life but couldn't name — to notice the felt sense of an emotion in my body, to distinguish between what was arising and how I was relating to it. The framework I encountered there — recursive self-acceptance, the window of tolerance, the insight that you can't anxiously monitor your way to wellbeing — became the design foundations for everything I'm building.
...
The interaction design draws on Lisa Feldman Barrett's constructed emotion theory — emotions aren't pre-formed things you detect but constructions from raw affect plus whatever conceptual frame you bring to the moment. The same physiological activation becomes anxiety or excitement depending on how you meet it. This is an instance of a deeper principle: all experience is frame-dependent, and the skill worth cultivating isn't finding the "true" read of your state but learning to navigate between frames with flexibility and discernment. The emotion picker isn't a labeling exercise — it's the instrument through which users practice constructing their experience more deliberately, discovering that the frame they bring to a sensation is itself a choice.
